...
import com.noteapp.di.DatabaseModule_ProvideNoteDaoFactory;
import com.noteapp.di.DatabaseModule_ProvideNoteDatabaseFactory;
...
import com.noteapp.presentation.screens.detail.NoteDetailViewModel;
import com.noteapp.presentation.screens.detail.NoteDetailViewModel_HiltModules;
import com.noteapp.presentation.screens.edit.NoteEditViewModel;
import com.noteapp.presentation.screens.edit.NoteEditViewModel_HiltModules;
import com.noteapp.presentation.screens.list.NoteListViewModel;
...
public final class DaggerNoteApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends NoteApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(3).put(LazyClassKeyProvider.com_noteapp_presentation_screens_detail_NoteDetailViewModel, NoteDetailViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_noteapp_presentation_screens_edit_NoteEditViewModel, NoteEditViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_noteapp_presentation_screens_list_NoteListViewModel, NoteListViewModel_HiltModules.KeyModule.provide()).build());
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_noteapp_presentation_screens_detail_NoteDetailViewModel = "com.noteapp.presentation.screens.detail.NoteDetailViewModel";

      static String com_noteapp_presentation_screens_list_NoteListViewModel = "com.noteapp.presentation.screens.list.NoteListViewModel";

      static String com_noteapp_presentation_screens_edit_NoteEditViewModel = "com.noteapp.presentation.screens.edit.NoteEditViewModel";

      @KeepFieldType
      NoteDetailViewModel com_noteapp_presentation_screens_detail_NoteDetailViewModel2;

      @KeepFieldType
      NoteListViewModel com_noteapp_presentation_screens_list_NoteListViewModel2;

      @KeepFieldType
      NoteEditViewModel com_noteapp_presentation_screens_edit_NoteEditViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends NoteApplication_HiltComponents.ViewModelC {
    ...
    private InsertNoteUseCase insertNoteUseCase() {
      return new InsertNoteUseCase(singletonCImpl.noteRepositoryImplProvider.get());
    }

    private UpdateNoteUseCase updateNoteUseCase() {
      return new UpdateNoteUseCase(singletonCImpl.noteRepositoryImplProvider.get());
    }
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(3).put(LazyClassKeyProvider.com_noteapp_presentation_screens_detail_NoteDetailViewModel, ((Provider) noteDetailViewModelProvider)).put(LazyClassKeyProvider.com_noteapp_presentation_screens_edit_NoteEditViewModel, ((Provider) noteEditViewModelProvider)).put(LazyClassKeyProvider.com_noteapp_presentation_screens_list_NoteListViewModel, ((Provider) noteListViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.noteapp.presentation.screens.detail.NoteDetailViewModel 
          return (T) new NoteDetailViewModel(viewModelCImpl.getNoteByIdUseCase(), viewModelCImpl.deleteNoteUseCase());

          case 1: // com.noteapp.presentation.screens.edit.NoteEditViewModel 
          return (T) new NoteEditViewModel(viewModelCImpl.getNoteByIdUseCase(), viewModelCImpl.insertNoteUseCase(), viewModelCImpl.updateNoteUseCase());

          case 2: // com.noteapp.presentation.screens.list.NoteListViewModel 
          return (T) new NoteListViewModel(viewModelCImpl.getAllNotesUseCase(), viewModelCImpl.deleteNoteUseCase(), viewModelCImpl.searchNotesUseCase());
